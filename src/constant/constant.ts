...
export const BABEL_EXAMPLE_HELPERS = [
  `${BABEL_RUNTIME_PREFIX_1}helpers/esm/typeof.js`,
  `${BABEL_RUNTIME_PREFIX_2}helpers/esm/typeof.js`,
]

export const BABEL_MINIFICATION_BLACKLIST_PRESET_NAMES: string[] = []
...
export const PRESERVING_PROPERTY_ACCESS_EXPRESSION_EXPRESSION =
  '__rollup_plugin_ts_temporary__'
export const PRESERVING_PROPERTY_ACCESS_EXPRESSION_NAME =
  '__property_access_member__'
...
export const ROLLUP_PLUGIN_MULTI_ENTRY =
  '\0rollup-plugin-multi-entry:entry-point'
...
export const DEBUG =
  process.env.ROLLUP_PLUGIN_TS_DEBUG === 'true' ||
  process.env.ROLLUP_PLUGIN_TS_DEBUG === '' ||
  process.env.ROLLUP_PLUGIN_TS_DEBUG === '1'
