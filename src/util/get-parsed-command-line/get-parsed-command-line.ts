 ...
 */
export function isParsedCommandLine(
  tsconfig?: IGetParsedCommandLineOptions['tsconfig'],
): tsconfig is ParsedCommandLine {
  return (
    tsconfig != null &&
...
export function isRawCompilerOptions(
  ...
  Record<keyof CompilerOptions, string | number | boolean>
> {
  return (
    tsconfig != null &&
    typeof tsconfig !== 'string' &&
 ...
 */
export function isTsConfigResolver(
  tsconfig?: IGetParsedCommandLineOptions['tsconfig'],
): tsconfig is TsConfigResolver {
 ...
 */
export function isTsConfigResolverWithFileName(
  tsconfig?: IGetParsedCommandLineOptions['tsconfig'],
): tsconfig is TsConfigResolverWithFileName {
  return (
    tsconfig != null &&
    typeof tsconfig !== 'string' &&
    typeof tsconfig !== 'function' &&
 ...
 */
export function isCompilerOptions(
  tsconfig?: IGetParsedCommandLineOptions['tsconfig'],
): tsconfig is Partial<CompilerOptions> {
  return (
    tsconfig != null &&
    typeof tsconfig !== 'string' &&
    typeof tsconfig !== 'function' &&
    ...
    (('module' in tsconfig && typeof tsconfig.module === 'number') ||
      ...
      ('moduleResolution' in tsconfig &&
        typeof tsconfig.moduleResolution === 'number') ||
...
export function getParsedCommandLine({
  ...
  // Otherwise, attempt to resolve it and parse it
    ...
    // Finally, if the user has provided a file that doesn't exist, throw
      ...
      throw new ReferenceError(
        `The given tsconfig: '${tsconfigPath}' doesn't exist!`,
      )
    }
    ...
    if (isTsConfigResolver(tsconfig)) {
      ...
      originalCompilerOptions = {
        ...tsconfig.hook(originalCompilerOptions),
        ...forcedCompilerOptions,
      }
      parsedCommandLine.options = {
        ...tsconfig.hook(parsedCommandLine.options),
        ...forcedCompilerOptions,
      }
    }
  }
  ...
  parsedCommandLine.fileNames = parsedCommandLine.fileNames.filter(file =>
