 ...
 */
function isBrowserslistInput(
  browserslist: IGetBrowserslistOptions['browserslist'],
): browserslist is string[] | string {
 ...
 */
function isBrowserslistQueryConfig(
  browserslist: IGetBrowserslistOptions['browserslist'],
): browserslist is IBrowserslistQueryConfig {
  return (
    browserslist != null &&
    !isBrowserslistInput(browserslist) &&
    browserslist !== false &&
    'query' in browserslist &&
    browserslist.query != null
  )
}
 ...
 */
function isBrowserslistPathConfig(
  browserslist: IGetBrowserslistOptions['browserslist'],
): browserslist is IBrowserslistPathConfig {
  return (
    browserslist != null &&
    !isBrowserslistInput(browserslist) &&
    browserslist !== false &&
    'path' in browserslist &&
    browserslist.path != null
  )
}
...
export function getBrowserslist({
  ...
  cwd,
  fileSystem,
}: IGetBrowserslistOptions): string[] | undefined {
